...
export default function page() {
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <p className='h-7 w-15 bg-red-300 font-bold'>Game</p>
        <p>April 11, 2024</p>
        </div>
        <div>
            <h1 className='font-bold text-4xl mt-6'>The Art of Game Design</h1>
        </div>
        <div>
            <Image src='/game2.jpg' alt='art' width='800' height='400' className='w-[100%] ml-[7px] mt-24 h-[600px]'/>
        </div>
        <div>
        ...
        <iframe width="1100" height="600" src="https://www.youtube.com/embed/DRxwtupRVNA?si=945ayDIb4gq_YKUy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div className='mt-20'>
