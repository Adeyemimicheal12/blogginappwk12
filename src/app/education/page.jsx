...
export default function page() {
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div>
            <h1 className='font-bold text-4xl mt-6'>Inclusive Education- Meeting the Needs of Every Student</h1>
        </div>
        <div>
            <Image src='/education.jpg' alt='art' width='800' height='400' className='w-[100%] ml-[7px] mt-24 h-[600px]'/>
        </div>
        <div>
