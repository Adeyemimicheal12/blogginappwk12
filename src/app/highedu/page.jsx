...
export default function page() {
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div>
            <h1 className='font-bold text-4xl mt-6'>Personalized Learning- The Future of Education</h1>
        </div>
        <div>
            <Image src='/education2.jpg' alt='art' width='800' height='400' className='w-[100%] ml-[7px] mt-24 h-[600px]'/>
        </div>
        <div>
        ...
        <iframe width="1100" height="600" src="https://www.youtube.com/embed/drlIUqRYM-w?si=KYv9YJkarqEMLpOG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div className='mt-20'>
